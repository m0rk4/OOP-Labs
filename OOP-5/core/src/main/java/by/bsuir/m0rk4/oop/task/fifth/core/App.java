package by.bsuir.m0rk4.oop.task.fifth.core;

import by.bsuir.m0rk4.oop.task.fifth.core.controller.PrimaryController;
...
public class App extends Application {
    ...
    private static final String APP_TITLE = "OOP - 5 / Patterns";
    ...
    public void start(Stage stage) throws IOException {
        ...
        Optional<XmlToJsonMapperFacade> xmlService = XmlToJsonMapperFacade.getService(moduleLayer);
